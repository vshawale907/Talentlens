const fs = require('fs');
const lines = fs.readFileSync('src/services/openai.service.ts', 'utf8').split('\n');
...
newLines.push(...lines.slice(278));
fs.writeFileSync('src/services/openai.service.ts', newLines.join('\n'));
console.log('Fixed');
