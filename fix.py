import json
with open('temp_lines.json', 'r', encoding='utf-8') as f:
    target_lines = json.load(f)

with open('backend/src/services/openai.service.ts', 'r', encoding='utf-8') as f:
    content = f.read()

target = '\n'.join(target_lines[5:26]) + '\n'
...
if target in content:
    ...
    with open('backend/src/services/openai.service.ts', 'w', encoding='utf-8') as f:
        f.write(content)
